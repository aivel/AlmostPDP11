...
namespace AlmostPDP11.VM.Decoder
{
    public class Decoder
    {
        ...
        public static Mnemonic GetMnemonic(ushort input)
        {
            ...
            if (doubleOperand < 7 && doubleOperand > 0)
            {
//Double-operand instructions
            ...
            if (doubleOperand == 7)
            {
//dditional two-operand instructions
            ...
            if (singleOperand == 1)
            {
//correct single-operand instruction
...
//conditional instructions
    ...
    public class Positioner
    {
        ...
        private static readonly ushort[] PossitionMultipliers = new ushort[16]
        {
